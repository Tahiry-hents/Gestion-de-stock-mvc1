              ...
              <f:hidden path="id"/>
                <div class="form-group row">
                  ...
                  <label><fmt:message key="common.prenom"/></label>
                    <f:input type="text" path="prenom" class="form-control form-control-user" id="exampleLastName" placeholder="Prénom"/>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <label><fmt:message key="common.numSecu"/></label>
                    <f:input type="text" path="numSecu" class="form-control form-control-user" id="exampleInputPassword" placeholder="Numéro de sécurité sociale"/>
                  </div>
                  <div class="col-sm-6">
                  <label><fmt:message key="common.telephone"/></label>
                    <f:input type="text" path="telephone" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="Numéro de téléphone"/>
                  </div>
                </div>
